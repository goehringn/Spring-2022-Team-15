...
public class SB {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Process pb = new ProcessBuilder("java", "src/main/java/Error.java", "400").start();
        ...
        while ((line = a.readLine()) != null) {
            ...
            if (argsArray[0].equals(words[0])) {
                switch (words[0]) {
                    case "Trans" -> {
                        Process pb = new ProcessBuilder("java", "src/main/java/Trans.java", argsArray[1]).start();
                        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
                            String l;
                            while ((l = reader.readLine()) != null) {
                                System.out.println(l);
                    ...
                    case "Tax" -> {
                        Process pb = new ProcessBuilder("java", "src/main/java/Tax.java", argsArray[1]).start();
                        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
                            String l;
                            while ((l = reader.readLine()) != null) {
                                System.out.println(l);
                    ...
                    case "TB" -> {
                        ...
                        Process pb = new ProcessBuilder("java", "src/main/java/TB.java", argsArray[1]).start();
                        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
                            String l;
                            while ((l = reader.readLine()) != null) {
                                System.out.println(l);
                    ...
                    case "Error" -> {
                        ...
                        Process pb = new ProcessBuilder("java", "src/main/java/Error.java", "Error").start();
                        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
                            String l;
                            while ((l = reader.readLine()) != null) {
                                System.out.println(l);
