  ...
  /*-------------------------------------------------------------
    ...
    *-------------------------------------------------------------*/
    ...
    void testLanguage1() throws Exception {
        String line;
        Process pb = new ProcessBuilder("java", "src/modules/Trans.java", "spanish,dog").start();
  ...
  /*-------------------------------------------------------------
    ...
    *-------------------------------------------------------------*/
    ...
    void testLanguage2() throws Exception {
        String line;
        Process pb = new ProcessBuilder("java", "src/modules/Trans.java", "german,dog").start();
        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
            line = reader.readLine();
        }
    ...
    void testLanguage3() throws Exception {
        String line;
        Process pb = new ProcessBuilder("java", "src/modules/Trans.java", "french,dog").start();
        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
            line = reader.readLine();
        }
    ...
    void testLanguage4() throws Exception {
        String line;
        Process pb = new ProcessBuilder("java", "src/modules/Trans.java", "spanish,bedroom").start();
        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
            line = reader.readLine();
        }
    ...
    void testLanguage5() throws Exception {
        String line;
        Process pb = new ProcessBuilder("java", "src/modules/Trans.java", "arabic,dog").start();
        try (var reader = new BufferedReader(new InputStreamReader(pb.getInputStream()))) {
            line = reader.readLine();
        }
